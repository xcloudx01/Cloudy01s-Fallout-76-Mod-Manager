  ...
  GetSelectedFileSubtype(ModFileFullPath)
    {
      ...
      loop % ValidZipTypes.Length()
        ...
        {
          debug("GetSelectedFileSubtype - The file: " . ModFileFullPath . " is a zipped file.")
          return "zipped"
        }
      if instr(ModFileFullPath,".ba2")
      {
        debug("GetSelectedFileSubtype - The file: " . ModFileFullPath . " is a ba2 file.")
        return "ba2"
      }
      else
      {
        debug("GetSelectedFileSubtype - The file: " . ModFileFullPath . " is not a mod file.")
        return
      }
    }
